...
<p align="center">
  <a href="(https://www.linkedin.com/in/adrian-euan-chan/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-blue?logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="mailto:a1drian5@hotmail.com">
...
### 🚀 About Me
I'm a **Senior Mobile Developer** with over 7 years of experience building **high-performance, scalable applications** for both **Android and iOS**.  
I specialize in **Kotlin, Jetpack Compose,SwiftUI, and Clean Architecture**, with cross-platform expertise using **Kotlin Multiplatform (KMM)**.  

I love designing clean, maintainable codebases, optimizing **CI/CD pipelines**, and crafting **secure, user-focused mobile experiences**.  
Currently exploring **Compose Multiplatform**, **Ktor**, and **modern design systems** to push the limits of cross-platform development.
...
| **Frameworks** | Jetpack Compose, SwiftUI, KMM |
| **Architecture** | MVVM, Clean Architecture, MVI |
| **Networking** | Retrofit, Ktor, WebSockets |
| **Storage** | Room, DataStore, SQLDelight |
| **Tools** | Firebase, GitLab CI/CD, Jenkins |
| **Other** | Dependency Injection (Hilt/Koin), Coroutines, Flow |
...
### 📫 Contact
If you’d like to collaborate or discuss mobile architecture ideas:  
📩 **a1drain5@hotmail.com**  
🔗 [**LinkedIn**](https://www.linkedin.com/in/adrian-euan-chan/)

---

<p align="center">
  <i>“Clean code is not written by following rules; it’s written by understanding why the rules exist.”</i>
</p>
